...
<x-app-layout>
    ...
    <div class="sticky top-0 z-20 border-b border-slate-800 bg-slate-900/90 backdrop-blur-sm">
        <div class="mx-auto max-w-5xl px-4 py-3 flex items-center justify-between">
            ...
            <span class="inline-flex items-center gap-1.5 rounded-full border border-amber-500/40 bg-amber-500/10 px-3 py-1 text-xs font-bold text-amber-400">
            ...
            <div class="grid grid-cols-3 items-center gap-4">
                ...
                <div class="text-center">
                    <div class="flex items-center justify-center gap-4">
                        <span class="text-5xl font-black tabular-nums text-white">{{ $homeScore }}</span>
                        <span class="text-2xl text-slate-600">×</span>
                        <span class="text-5xl font-black tabular-nums text-white">{{ $awayScore }}</span>
                    </div>
                    <div class="mt-2">
                        <span class="inline-flex items-center gap-1.5 rounded-full border border-amber-500/30 bg-amber-500/10 px-3 py-1 text-xs font-bold text-amber-400">
                            45' · Intervalo
                        </span>
                    </div>
                </div>
        ...
        <div class="grid gap-6 lg:grid-cols-3">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                >
                        ...
                        <div class="divide-y divide-slate-800/60">
                            @foreach ($starters as $player)
                                <div class="flex items-center gap-3 px-4 py-2.5"
                                    ...
                                    <span class="text-xs text-slate-600 tabular-nums">{{ $player->fitness }}% fitness</span>
                    ...
                    >
                        @csrf
                        {{-- Campos hidden gerados pelo Alpine --}}
                        <template x-for="(sub, idx) in subs" :key="idx">
                            <div>
                ...
                @elseif (! $canResume)
                    {{-- Aguardando o técnico do time iniciar --}}
