            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('leagues.create') }}"
                        class="inline-flex items-center gap-2 rounded-xl bg-violet-500 px-4 py-2 text-sm font-bold uppercase tracking-wider text-white transition hover:bg-violet-400 active:scale-95">
    ...
    <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        @if ($leagues->isEmpty())
            <div class="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-700 bg-slate-900/40 px-8 py-20 text-center">
                ...
                <p class="mb-6 text-sm text-slate-400">Crie ou entre numa liga para começar a jogar.</p>
                <div class="flex gap-3">
                    <a href="{{ route('leagues.create') }}"
                        class="rounded-xl bg-violet-500 px-5 py-2.5 text-sm font-bold text-white transition hover:bg-violet-400">
                        Criar Liga
                    </a>
                    <a href="{{ route('leagues.join') }}"
