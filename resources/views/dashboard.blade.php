    ...
    <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 space-y-12">
        ...
        <div>
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                ...
                {{-- Criar liga --}}
                <div class="group relative flex flex-col rounded-2xl border border-slate-700 bg-slate-900 p-6 transition hover:border-violet-500/60 hover:bg-slate-800/60">
                    ...
                    <p class="mb-6 flex-1 text-sm leading-relaxed text-slate-400">
                        Crie seu próprio mundo de jogo, convide amigos e dispute os campeonatos juntos no seu ritmo.
                    </p>
