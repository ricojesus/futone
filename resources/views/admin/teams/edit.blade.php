<x-app-layout>
    <div class="mx-auto max-w-2xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <p class="text-xs font-semibold uppercase tracking-widest text-slate-500">Administração · Times</p>
            <h1 class="text-2xl font-extrabold text-white">Editar Time</h1>
        </div>
